...
impl KernelUring {
    ...
    pub fn new(entries: u32) -> io::Result<Self> {
        ...
        let cq_ring_size =
            params.cq_off.cqes + params.cq_entries * mem::size_of::<KernelCQE>() as u32;
        ...
        let cqes = unsafe { cq_ring_ptr.add(params.cq_off.cqes as usize) as *mut KernelCQE };
    ...
    pub fn submit_direct(&self, sqe: &KernelSQE) -> io::Result<()> {
        unsafe {
            ...
            ptr::write_volatile(self.mapped.sqe_ptr.as_ptr().add(idx as usize), *sqe);
...
mod tests {
    ...
    #[test]
    #[ignore]
    fn test_async_uring_with_failover() {
        ...
        if cfg!(target_os = "linux") {
            ...
            let mut buf = [0u8; 10];
            let result = adapter.read(fd, &mut buf);
